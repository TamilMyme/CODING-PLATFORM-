...
const Institutions: React.FC = () => {
  ...
  const [viewingInstitution, setViewingInstitution] = useState<InstitutionRow | null>(null);
  ...
  return (
    <div className="bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50 min-h-screen">
      ...
      {/* View Modal */}
      {showViewModal && viewingInstitution && (
            ...
            <div className="bg-gradient-to-r from-indigo-600 to-purple-600 px-6 py-6 text-white">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-indigo-100 mt-1">View comprehensive institution information</p>
                </div>
                <button
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-center gap-4 pb-6 border-b border-gray-200">
                  <div className={`w-20 h-20 rounded-2xl flex items-center justify-center text-white text-3xl font-bold ${
                    viewingInstitution.type === "COLLEGE" 
                      ? 'bg-gradient-to-br from-blue-400 to-blue-600' 
                      : 'bg-gradient-to-br from-purple-400 to-purple-600'
                  }`}>
                    {viewingInstitution.name?.charAt(0).toUpperCase() || 'I'}
                  </div>
                  <div>
                    <h4 className="text-2xl font-bold text-gray-900">{viewingInstitution.name}</h4>
                    <span className={`inline-flex items-center px-3 py-1 rounded-full text-xs font-medium mt-2 ${
                      viewingInstitution.type === "COLLEGE"
                        ? 'bg-blue-100 text-blue-800'
                        : 'bg-purple-100 text-purple-800'
                    }`}>
                      {viewingInstitution.type === "COLLEGE" ? "College" : "Organization"}
                    </span>
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="bg-gray-50 rounded-lg px-4 py-3">
                      ...
                      <p className="text-gray-900 font-medium">{viewingInstitution.address || 'Not specified'}</p>
                    </div>
                    <div className="bg-gray-50 rounded-lg px-4 py-3">
                 ...
                 <div>
                   ...
                   <div className="bg-gradient-to-br from-indigo-50 to-indigo-100 rounded-lg px-4 py-4">
                     <div className="flex items-center gap-2 mb-2">
                       ...
                       <span className="text-sm font-medium text-indigo-900">Admins</span>
                     </div>
                     <p className="text-3xl font-bold text-indigo-600">{viewingInstitution.admins?.length || 0}</p>
                   </div>
                 </div>
               </div>
            </div>
